...
const Contact = () => {
    ...
    return (
        <>
            <section id="contact">
                <div className="p-10 grid-2 g-3 align-initial">
                    <div>
                    ...
                    <form action="" onSubmit={handleSubmit}>
                        ...
                        <input type="text" name="name" className={"form-control text-dark"} value={inpData.name}
                               onChange={handleChange}/>

                        <label htmlFor="" className={"fs-1-5 fw-3 mt-5"}> Email</label>
                        <input type="text" name={"mail"} className={"form-control text-dark"} value={inpData.mail}
                               onChange={handleChange}/>

                        <label htmlFor="" className={"fs-1-5 fw-3 mt-5"}> Message</label>
                        <textarea name="msg" cols="30" rows="10" className={"form-control text-dark"}
                                  value={inpData.msg} onChange={handleChange}></textarea>
